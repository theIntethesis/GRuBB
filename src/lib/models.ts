...
export const Budget = mongoose.models.Budget || mongoose.model<I_Budget>("Budget", BudgetSchema)
export const Faculty =  mongoose.models.Faculty || mongoose.model<I_Faculty>("Faculty", FacultySchema)
export const Individual = mongoose.models.Individual || mongoose.model<I_Individual>("Individual", IndividualSchema)
export const InstitutionalAccount =  mongoose.models.InstitutionalAccount || mongoose.model<I_InstitutionalAccount>("InstitutionalAccount", InstitutionalAccountSchema)
export const OverheadCharge = mongoose.models.OverheadCharge || mongoose.model<I_OverheadCharge>("OverheadCharge", OverheadChargesSchema)
export const SalaryAccount = mongoose.models.SalaryAccount || mongoose.model<I_SalaryAccount>("SalaryAccount", SalaryAccountSchema)
export const Student = mongoose.models.Student || mongoose.model<I_Student>("Student", StudentSchema)
export const StudentAccount = mongoose.models.StudentAccount || mongoose.model<I_StudentAccount>("StudentAccount", StudentAccountSchema)
export const TravelProfile =  mongoose.models.TravelProfile || mongoose.model<I_TravelProfile>("TravelProfile", TravelProfileSchema)
